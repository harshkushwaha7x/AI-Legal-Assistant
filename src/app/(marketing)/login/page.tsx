...
import { Scale, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center px-4 pt-16">
            ...
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute -left-40 top-20 h-[500px] w-[500px] rounded-full bg-primary-600/8 blur-[128px]" />
                <div className="absolute -right-40 bottom-20 h-[400px] w-[400px] rounded-full bg-accent-500/6 blur-[128px]" />
            </div>
